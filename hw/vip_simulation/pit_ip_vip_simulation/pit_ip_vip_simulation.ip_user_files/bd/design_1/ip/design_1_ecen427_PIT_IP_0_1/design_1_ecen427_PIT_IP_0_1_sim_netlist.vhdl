...
-- Date        : Fri Nov 20 14:39:38 2020
-- Host        : ELO-arch running 64-bit Manjaro Linux
-- Command     : write_vhdl -force -mode funcsim
--               /home/christopolise/FALL_2020/ECEN_427/labs/427-labs-christopolise/hw/vip_simulation/pit_ip_vip_simulation/pit_ip_vip_simulation.srcs/sources_1/bd/design_1/ip/design_1_ecen427_PIT_IP_0_1/design_1_ecen427_PIT_IP_0_1_sim_netlist.vhdl
...
entity design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0_S00_AXI : entity is "ecen427_PIT_IP_v1_0_S00_AXI";
end design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0_S00_AXI;

architecture STRUCTURE of design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0_S00_AXI is
  ...
  signal interrupt_flag_INST_0_i_1_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_2_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_3_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_4_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_5_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_6_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_7_n_0 : STD_LOGIC;
  signal interrupt_flag_INST_0_i_8_n_0 : STD_LOGIC;
...
interrupt_flag_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00800000"
    )
        port map (
...
interrupt_flag_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
interrupt_flag_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
interrupt_flag_INST_0_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
interrupt_flag_INST_0_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
...
interrupt_flag_INST_0_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
interrupt_flag_INST_0_i_6: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
interrupt_flag_INST_0_i_7: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
interrupt_flag_INST_0_i_8: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0 is
  port (
    S_AXI_ARREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0 : entity is "ecen427_PIT_IP_v1_0";
end design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0;

architecture STRUCTURE of design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0 is
begin
ecen427_PIT_IP_v1_0_S00_AXI_inst: entity work.design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ecen427_PIT_IP_0_1 is
  port (
    interrupt_flag : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_ecen427_PIT_IP_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_ecen427_PIT_IP_0_1 : entity is "design_1_ecen427_PIT_IP_0_1,ecen427_PIT_IP_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_ecen427_PIT_IP_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_ecen427_PIT_IP_0_1 : entity is "ecen427_PIT_IP_v1_0,Vivado 2017.4";
end design_1_ecen427_PIT_IP_0_1;

architecture STRUCTURE of design_1_ecen427_PIT_IP_0_1 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of interrupt_flag : signal is "xilinx.com:signal:interrupt:1.0 interrupt_flag INTERRUPT";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of interrupt_flag : signal is "XIL_INTERFACENAME interrupt_flag, SENSITIVITY edge_rising, PortWidth 1";
...
inst: entity work.design_1_ecen427_PIT_IP_0_1_ecen427_PIT_IP_v1_0
     port map (
