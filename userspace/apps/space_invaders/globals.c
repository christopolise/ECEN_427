...
void update_score() {
    ...
    hdmi_print_string(score_old, strlen(score), SCALE_FACTOR, globalBack, globalBack, SCORE_POS_Y,
                      SCORE_POS_X);
    hdmi_print_string(score, strlen(score), SCALE_FACTOR, globalFore, globalBack, SCORE_POS_Y,
                      SCORE_POS_X);
}
...
void update_lives() {
    ...
    if (inc_or_dec == INCREMENT) {
        hdmi_draw_sprite(sprite_tank_17x8, TANK_WIDTH, TANK_HEIGHT, SCALE_LIFE, globalTank,
        ...
        hdmi_draw_sprite(sprite_tank_17x8, TANK_WIDTH, TANK_HEIGHT, SCALE_LIFE, globalBack,
                         globalBack, LIVES_POS_Y,
                         HDMI_DISPLAY_WIDTH -
                             (LIVES_START_POS + (LIVES_WIDTH - globals_old_lives * LIVES_WIDTH)));
    }
}
