...
// Takes the given sprite line and scales it up correctly to facilitate line-scaled sprites
// for faster writing
...
// @param - background_color char * that denotes background_color color of sprite
void create_sprite_write_line_buffer(uint8_t width, uint8_t scale, uint8_t *buf_in, char *buf_out,
...
// letter starts
void print_char(char letter, uint8_t scale, char foreground_color[HDMI_COLOR_FACTOR],
                char background_color[HDMI_COLOR_FACTOR], uint32_t x_offset, uint32_t y_offset) {
    switch (tolower(letter)) {
        ...
        // scale
    case 'a':
        hdmi_draw_sprite(sprite_letterA_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'b':
        hdmi_draw_sprite(sprite_letterB_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'c':
        hdmi_draw_sprite(sprite_letterC_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'd':
        hdmi_draw_sprite(sprite_letterD_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'e':
        hdmi_draw_sprite(sprite_letterE_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'f':
        hdmi_draw_sprite(sprite_letterF_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'g':
        hdmi_draw_sprite(sprite_letterG_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'h':
        hdmi_draw_sprite(sprite_letterH_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'i':
        hdmi_draw_sprite(sprite_letterI_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'j':
        hdmi_draw_sprite(sprite_letterJ_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'k':
        hdmi_draw_sprite(sprite_letterK_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'l':
        hdmi_draw_sprite(sprite_letterL_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'm':
        hdmi_draw_sprite(sprite_letterM_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'n':
        hdmi_draw_sprite(sprite_letterN_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'o':
        hdmi_draw_sprite(sprite_letterO_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'p':
        hdmi_draw_sprite(sprite_letterP_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'q':
        hdmi_draw_sprite(sprite_letterQ_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'r':
        hdmi_draw_sprite(sprite_letterR_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 's':
        hdmi_draw_sprite(sprite_letterS_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 't':
        hdmi_draw_sprite(sprite_letterT_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'u':
        hdmi_draw_sprite(sprite_letterU_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'v':
        hdmi_draw_sprite(sprite_letterV_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'w':
        hdmi_draw_sprite(sprite_letterW_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'x':
        hdmi_draw_sprite(sprite_letterX_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'y':
        hdmi_draw_sprite(sprite_letterY_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case 'z':
        hdmi_draw_sprite(sprite_letterZ_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '0':
        hdmi_draw_sprite(sprite_number0_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '1':
        hdmi_draw_sprite(sprite_number1_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '2':
        hdmi_draw_sprite(sprite_number2_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '3':
        hdmi_draw_sprite(sprite_number3_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '4':
        hdmi_draw_sprite(sprite_number4_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '5':
        hdmi_draw_sprite(sprite_number5_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '6':
        hdmi_draw_sprite(sprite_number6_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '7':
        hdmi_draw_sprite(sprite_number7_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '8':
        hdmi_draw_sprite(sprite_number8_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case '9':
        hdmi_draw_sprite(sprite_number9_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    case ' ':
        hdmi_draw_sprite(sprite_letterBLANK_5x5, LETTER_DIM, LETTER_DIM, scale, foreground_color,
                         background_color, x_offset, y_offset);
        break;
    }
}
...
void draw_pixel(uint32_t pos_x, uint32_t pos_y, char color[HDMI_COLOR_FACTOR], uint8_t scale) {
    ...
    for (uint16_t i = 0; i < scale; i++) {
        ...
        // to the next line
        lseek(fd,
              (pos_x * HDMI_COLOR_FACTOR) + (pos_y * HDMI_COLOR_FACTOR * HDMI_DISPLAY_WIDTH) +
...
void hdmi_print_string(char *mesg, uint16_t str_size, uint8_t scale,
                       char foreground_color[HDMI_COLOR_FACTOR],
                       char background_color[HDMI_COLOR_FACTOR], uint32_t y_offset,
                       uint32_t x_offset) {
...
void hdmi_draw_sprite(const uint32_t *sprite_name, uint8_t width, uint8_t height, uint8_t scale,
                      char foreground_color[HDMI_COLOR_FACTOR],
                      char background_color[HDMI_COLOR_FACTOR], uint32_t y_offset,
                      uint32_t x_offset) {
    ...
    for (row = 0; row < height; row++) {
        ...
        create_sprite_write_line_buffer(width, scale, sprite_line, row_data, foreground_color,
                                        background_color);
...
void hdmi_draw_row(uint32_t pos_y, char color[HDMI_COLOR_FACTOR]) {
    ...
    for (uint16_t i = 0; i < (HDMI_DISPLAY_WIDTH * HDMI_COLOR_FACTOR); i += HDMI_COLOR_FACTOR) {
